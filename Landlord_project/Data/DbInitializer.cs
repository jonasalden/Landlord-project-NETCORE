    ...
    public static class DbInitializer
    {
        public static void Seed(DataContext context)
        {
            if (!context.Residences.Any())
            {
                ...
                {
                    new ResidenceReport{FirstName = "Erika", LastName = "Bratt", DateCreated = DateTime.Now, Email = "erika@mail.com", Phone = "434343", ResidenceId = 1, Description = "Stopp i toaletten"}
                };
