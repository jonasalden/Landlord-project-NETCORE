        ...
        public static void Seed(DataContext context)
        {
            if (!context.Residences.Any())
            {
                ...
                var residences = new Residence[]
                {
                    ...
                    new Residence {Address = "Studentvägen 25", Area = "Uppsala", Featured = false, CanRental = false, DateBuilt = DateTime.Parse("2005-04-28"), ApplicationFrom = DateTime.Parse("2020-04-24"), DateRenovated = DateTime.Parse("2001-11-10"), Description = "Studentbostad", Estate = "Varianten", FloorNumber = 1, RentalPrice = 2030, Rooms = 1, ShowFrom = DateTime.Parse("2020-02-10"), ShowTo = DateTime.Parse("2020-02-20"), Size = 14, TypeOfResidence = ResidenceGroupType.Student, ImageName = "residence_3.jpg", ImageMimeType = "image/jpeg", Longitude = "17.613843", Latitude = "59.854356"} 
                };
